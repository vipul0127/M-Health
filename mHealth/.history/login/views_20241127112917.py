...
def view_files(request):
    ...
    # Retrieve only Google Sheets uploaded by the current user
    google_sheets = GoogleSheet.objects.filter(user=current_user)  # Assuming 'uploaded_by' is the field linking to the User
