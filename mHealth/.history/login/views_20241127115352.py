    ...
    if request.method == 'POST':
        ...
        if form.is_valid():
            ...
            google_sheet = GoogleSheet(
                ...
                title=form.cleaned_data['title'],  # Capture the title from the form
                sheet_url=form.cleaned_data['google_sheet_url'],  # Get the URL from the form
            )
            google_sheet.save()  # Save the model instance
            return redirect('upload_success')  # Redirect to a success pagex
    else:
        form = UploadFileForm()
